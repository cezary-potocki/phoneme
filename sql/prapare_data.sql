...
ARB_MODEL_VARIANTS VARCHAR(20000),
ARB_YAMLI_VARIANTS VARCHAR(20000),
FROM_ENG_ENG_INVALIDATED VARCHAR(20000),
FROM_ENG_ENG_MODEL_INVALIDATED VARCHAR(20000),
FROM_ENG_ARB_INVALIDATED VARCHAR(20000),
FROM_ENG_ARB_MODEL_INVALIDATED VARCHAR(20000),
FROM_ENG_ARB_YAMLI_INVALIDATED VARCHAR(20000),
FROM_ARB_ENG_INVALIDATED VARCHAR(20000),
FROM_ARB_ENG_MODEL_INVALIDATED VARCHAR(20000),
FROM_ARB_ARB_INVALIDATED VARCHAR(20000),
FROM_ARB_ARB_MODEL_INVALIDATED VARCHAR(20000),
FROM_ARB_ARB_YAMLI_INVALIDATED VARCHAR(20000),
...
select trim(eng), trim(arb), trim(eng_variants), trim(eng_model_variants), trim(arb_variants), trim(arb_model_variants), trim(arb_yamli_variants)
